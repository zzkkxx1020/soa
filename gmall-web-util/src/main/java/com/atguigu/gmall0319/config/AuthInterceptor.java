            ...
            if ("success".equals(result)){
                ...
                return true;
                    ...
                    if (loginRequireAnnotation.autoRedirect()){
                         // 获取url getRequestURI(); requestURL http://item.gmall.com/28.html
                        String requestURL = request.getRequestURL().toString();
                        // http%3A%2F%2Fitem.gmall.com%2F28.html 转换成utf-8 url编码
                        String encodeURL  = URLEncoder.encode(requestURL, "UTF-8");
                        // 让用户进行登录 http://passport.atguigu.com/index?originUrl=http%3A%2F%2Fitem.gmall.com%2F28.html
